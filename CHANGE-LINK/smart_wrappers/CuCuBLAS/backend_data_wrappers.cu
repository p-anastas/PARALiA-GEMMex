...
void* CHLMalloc(long long bytes, short loc, short W_flag){
  void *ptr = NULL;
...
void CHLMemcpy(void* dest, void* src, long long bytes, short loc_dest, short loc_src)
{
...
/*void CHLMemcpyAsync(void* dest, void* src, long long bytes, short loc_dest, short loc_src, CQueue_p transfer_queue)
{
...
void CHLMemcpy2D(void* dest, long int ldest, void* src, long int ldsrc, long int rows, long int cols, short elemSize, short loc_dest, short loc_src){
	short lvl = 6;
#ifdef DDEBUG
...
void CHLVecInit(VALUETYPE *vec, long long length, int seed, short loc)
{
...
template void CHLVecInit<double>(double *vec, long long length, int seed, short loc);
template void CHLVecInit<float>(float *vec, long long length, int seed, short loc);