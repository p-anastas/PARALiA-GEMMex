...
char* OUTPUT_ALGO_MODE = OUTPUT_ALGO_MODE_IN;
int STREAMING_BUFFER_OVERLAP = STREAMING_BUFFER_OVERLAP_IN;
char* DISTRIBUTION = DISTRIBUTION_IN;
char* ORDER_2DBC = ORDER_2DBC_IN;
char* TASK_ORDER = TASK_ORDER_IN;
char* FETCH_ROUTING = FETCH_ROUTING_IN;
char* WB_ROUTING = WB_ROUTING_IN;
char* PREDICT_OPTIMIZE_TARGET = PREDICT_OPTIMIZE_TARGET_IN;
